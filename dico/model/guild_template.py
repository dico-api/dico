...
class GuildTemplate:
    ...
    RESPONSE_AS_LIST = typing.Union[
        typing.List["GuildTemplate"], typing.Awaitable[typing.List["GuildTemplate"]]
    ]
    ...
    def __init__(self, client: "APIClient", resp: dict):
        ...
        self.serialized_source_guild: Guild = Guild.create(
            client, resp["serialized_source_guild"]
        )
