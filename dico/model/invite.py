...
class Invite:
    ...
    RESPONSE_AS_LIST = typing.Union[
        typing.List["Invite"], typing.Awaitable[typing.List["Invite"]]
    ]
    ...
    def __init__(self, client: "APIClient", resp: dict):
        ...
        self.guild: typing.Optional[Guild] = (
            Guild.create(client, self.__guild) if self.__guild else self.__guild
        )
        ...
        self.expires_at: typing.Optional[datetime.datetime] = (
            datetime.datetime.fromisoformat(self.__expires_at)
            if self.__expires_at
            else self.__expires_at
        )
        self.__stage_instance = resp.get("stage_instance")
        self.stage_instance: typing.Optional[InviteStageInstance] = (
...
class InviteStageInstance:
    def __init__(self, client: "APIClient", resp: dict):
        self.members: typing.List[GuildMember] = [
            GuildMember.create(client, x) for x in resp["members"]
        ]
