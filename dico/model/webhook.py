...
class Webhook:
    ...
    RESPONSE_AS_LIST = typing.Union[
        typing.List["Webhook"], typing.Awaitable[typing.List["Webhook"]]
    ]
    ...
    def __init__(self, client: "APIClient", resp: dict):
        ...
        self.source_guild: typing.Optional[Guild] = (
            Guild.create(client, self.__source_guild)
            if self.__source_guild
            else self.__source_guild
        )
        self.__source_channel = resp.get("source_channel")
        self.source_channel: typing.Optional[Channel] = (
            Channel.create(client, self.__source_channel)
            if self.__source_channel
            else self.__source_channel
        )
    ...
    def request_message(
        self, message: typing.Union[str, int, Snowflake, Message]
    ) -> Message.RESPONSE:
