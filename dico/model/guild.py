...
class Guild(DiscordObjectBase):
    ...
    def list_members(self, limit: int = None, after: str = None) -> "GuildMember.RESPONSE_AS_LIST":
    ...
    def modify_role_positions(self, *params: dict, reason: str = None) -> Role.RESPONSE_AS_LIST:
    ...
    def request_prune_count(self, *, days: int = None, include_roles: typing.List[Role.TYPING] = None) -> AbstractObject.RESPONSE:
    ...
    def modify_widget(self, *, enabled: bool = None, channel: "Channel.TYPING" = EmptyObject, reason: str = None) -> "GuildWidget.RESPONSE":
...
class GuildMember:
    ...
    def __init__(self, client: "APIClient", resp: dict, *, user: User = None, guild_id: Snowflake = None):
        self.raw: dict = resp
        ...
        self.premium_since: datetime.datetime = datetime.datetime.fromisoformat(self.__premium_since) if self.__premium_since else self.__premium_since
        ...
        self.guild_id: typing.Optional[Snowflake] = Snowflake.optional(resp.get("guild_id")) or Snowflake.ensure_snowflake(guild_id)
...
class Integration:
    ...
    def __init__(self, client: "APIClient", resp: dict):
        ...
        self.role_id: typing.Optional[Snowflake] = Snowflake.optional(resp.get("role_id"))
        self.enable_emoticons: typing.Optional[bool] = resp.get("enable_emoticons")
        self.__expire_behavior = resp.get("expire_behavior")
        self.expire_behavior: typing.Optional[IntegrationExpireBehaviors] = IntegrationExpireBehaviors(int(self.__expire_behavior)) if self.__expire_behavior else self.__expire_behavior
        ...
        self.synced_at: typing.Optional[datetime.datetime] = datetime.datetime.fromisoformat(self.__synced_at) if self.__synced_at else self.__synced_at
        ...
        self.application: typing.Optional[IntegrationApplication] = IntegrationApplication(client, self.__application) if self.__application else self.__application
...
class WelcomeScreen:
    ...
    def __init__(self, resp: dict):
        self.description: typing.Optional[str] = resp["description"]
        self.welcome_channels: typing.List[WelcomeScreenChannel] = [WelcomeScreenChannel(x) for x in resp["welcome_channels"]]
